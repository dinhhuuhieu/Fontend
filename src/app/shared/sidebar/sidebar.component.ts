...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Quản lý',url:'',icon:'signal',childs:[{name:'Quản lý hợp đồng',url:'/product/hopdong'},{name:'Quản lý chi tiết hợp đồng',url:'/product/chitiethopdong'},{name:'Quản lý loại xe',url:'/product/loai'},{name:'Quản lý nhà sản xuất',url:'/product/nhasanxuat'},{name:'Quản lý sản phẩm',url:'/product/sanpham'}]}];
  constructor() { } 
  ngOnInit(): void {
  }
  ngAfterViewInit() {
